    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- Optionally, you can add icons to the links -->
          ...
          <li><a href="salesreport.php"><i class="fa fa-report"></i> <span>Sales Man | Sales-Report</span></a></li>
    ...
    <section class="content container-fluid">
        <div class="box box-primary">
            ...
            <form class="form-horizontal">
              ...
              <h5 class="col-sm-1 control-label">Select a Product</h5>

                  <div class="col-sm-4" style="margin-top: 15px;">
                  <select class="form-control select2" style="width:100%;" name="pdt">
                      <option selected>select product&hellip;</option>
                      <option>from db..</option>
                      <option>from prdt--</option>
                      <option>from pdt--</option>
                      </select>
                </div>
                <div class="col-sm-3">
                  <input type="number" name="qty" value="1" min="1" placeholder="Qty" autocomplete="off" style="width: 78px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px; margin-top: 15px;" / required>
                ...
                <div class="col-sm-3">
                 <button class="btn btn-default pull-right" style="margin-top: 15px; background: #00C0EF;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Product</button>
                </div>
              </div>
